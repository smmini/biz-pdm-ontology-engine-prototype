...
from ontology.mapping_agent import map_all_sources
from ontology.capability_detector import detect_capabilities
from feature_catalog.builder import load_catalog, build_features, save_features_npy
from prediction.label_builder import build_labels
